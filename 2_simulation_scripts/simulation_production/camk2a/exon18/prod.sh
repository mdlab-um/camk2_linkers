...
gmx_mpi mdrun -deffnm s1_400k -s step5_1_400k.tpr -ntomp 4 -nb gpu -pme gpu -bonded gpu -gpu_id 2 -pin on -pinoffset 16 &
gmx_mpi mdrun -deffnm s2_400k -s step5_1_400k.tpr -ntomp 4 -nb gpu -pme gpu -bonded gpu -gpu_id 3 -pin on -pinoffset 24 &
