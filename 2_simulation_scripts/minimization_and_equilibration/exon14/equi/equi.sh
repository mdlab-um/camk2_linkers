...
gmx_mpi grompp -f ./../step4.1_equilibration.mdp -o step4.1_equilibration.tpr -c ./../mini/step4.0_minimization.gro -r ./../step3_input.gro -p ./../topol.top -n ./../index.ndx
