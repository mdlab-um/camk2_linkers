...
aln.append(file="rexon18.ali", align_codes="rexon18")

aln.align2d(max_gap_length=50)
aln.write(file='rexon18_fill.ali', alignment_format='PIR')
aln.write(file='rexon18_fill.pap', alignment_format='PAP')
