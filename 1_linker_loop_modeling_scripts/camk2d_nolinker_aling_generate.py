...
pdb_file = "ABCD_truncated_clean.pdb"  # for example, this pdb structure has some missing loops
...
aln.append(file="control.ali", align_codes="control")

aln.align2d(max_gap_length=50)
aln.write(file='control_fill.ali', alignment_format='PIR')
aln.write(file='control_fill.pap', alignment_format='PAP')
